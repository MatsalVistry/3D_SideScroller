...
public class ImageTools {
    ...
    public static BufferedImage copy(BufferedImage img) {
        BufferedImage copy = new BufferedImage(img.getWidth(),img.getHeight(),img.getTransparency());
    ...
    public static BufferedImage scale(BufferedImage img, double horizontalScale,
        ...
        if(img != null) {
            dbi = new BufferedImage((int)horizontalScale, (int)verticalScale,2);
            Graphics2D g = dbi.createGraphics();
            AffineTransform at = AffineTransform.getScaleInstance(horizontalScale, verticalScale);
    ...
    //got a boo out of control without getting lost in the sauce
